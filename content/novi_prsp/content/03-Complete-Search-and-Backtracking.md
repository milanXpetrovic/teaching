...
### Što je potpuna pretraga?
**Potpuna pretraga** (engl. *complete search* ili *brute force*) je fundamentalna tehnika rješavanja problema koja se svodi na generiranje svih mogućih rješenja i provjeru svakog od njih. Iako se često čini "naivnom" ili neefikasnom, ona je temelj mnogih naprednijih algoritama i često je najbolje rješenje za probleme s malim ulaznim ograničenjima.
...
-   Ako je `n ≤ 20`, algoritam složenosti **O(2^n)** (generiranje podskupova) je vjerojatno prihvatljiv.
-   Ako je `n ≤ 10`, algoritam složenosti **O(n!)** (generiranje permutacija) može biti prihvatljiv.
...
*   **CPH (Competitive Programmer's Handbook):**
    *   Poglavlje 5: *Complete search*
*   **CLRS (Introduction to Algorithms):**
    *   CLRS nema posvećeno poglavlje potpunoj pretrazi, ali koncept backtrackinga je opisan u kontekstu rješavanja problema, npr. u uvodu u NP-potpunost (Poglavlje 34). CPH je ovdje primarni izvor.
